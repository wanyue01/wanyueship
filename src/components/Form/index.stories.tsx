...
RegForm.storyName = '注册表单，支持多种 FormItem 组件';

export const FullForm = (args: any) => {
  ...
  return (
    <Form initialValues={{ username: 'wanyue', agreement: false }} {...args} ref={ref}>
