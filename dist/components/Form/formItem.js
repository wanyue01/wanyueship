...
export var FormItem = function (props) {
    var _a = props, name = _a.name, label = _a.label, children = _a.children, valuePropName = _a.valuePropName, valueChangeHandlerName = _a.valueChangeHandlerName, getValueFromEvent = _a.getValueFromEvent, valueCheckHandlerName = _a.valueCheckHandlerName, rules = _a.rules;
    // console.log('name', name);
    var rowClass = classNames('form-item-row', {
        'row-no-label': !label,
    });
    ...
    useEffect(function () {
        ...
        dispatch({ type: 'addField', name: name, value: { name: name, value: typeof initialValue !== 'undefined' ? initialValue : '', rules: rules || [], errors: [] } });
        // eslint-disable-next-line react-hooks/exhaustive-deps
    }, []);
    // 获取store对应的value
    var fieldState = fields[name];
    var value = fieldState === null || fieldState === void 0 ? void 0 : fieldState.value;
    var errors = fieldState === null || fieldState === void 0 ? void 0 : fieldState.errors;
    ...
    var itemClass = classNames('form-item-control', {
        'form-item-has-error': hasError,
    });
    var onVauleUpdate = function (e) {
    ...
    return (React.createElement("div", { className: rowClass },
        ...
        React.createElement("div", { className: 'form-item' },
            ...
            hasError &&
                React.createElement("div", { className: 'form-item-explain' },
