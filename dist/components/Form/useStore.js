...
var mapValues = function (fields, cb) {
    return Object.keys(fields).reduce(function (prev, cur) {
        prev[cur] = cb(fields[cur]);
        return prev;
    }, {});
};
export default function useStore(initialVaules) {
    var _this = this;
    var _a = useState({ isValid: false, isSubmitting: false, errors: {} }), form = _a[0], setForm = _a[1];
    ...
    var resetFields = function () {
        if (initialVaules) {
            for (var name_1 in initialVaules) {
                if (fields[name_1]) {
                    dispatch({ type: 'updateValue', name: name_1, value: initialVaules[name_1] });
                }
                else {
                    dispatch({ type: 'updateValue', name: name_1, value: '' });
                }
            }
        }
    };
    ...
    var validateField = function (name) { return __awaiter(_this, void 0, void 0, function () {
        var _a, value, rules, descriptor, valueMap, validator, isValid, errors, error_1, err;
        var _b, _c;
    ...
    var validateAllFields = function () { return __awaiter(_this, void 0, void 0, function () {
        var isValid, errors, valueMap, descriptor, validator, error_2, err, name_2;
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 3:
                    ...
                    err = error_2;
                    errors = err.fields;
                    for (name_2 in fields) {
                        if (errors[name_2]) {
                            dispatch({ type: 'updateValidateResult', name: name_2, value: { isValid: isValid, errors: errors[name_2] } });
                        }
                        else if (!errors[name_2] && fields[name_2].rules.length > 0) {
                            dispatch({ type: 'updateValidateResult', name: name_2, value: { isValid: true, errors: [] } });
                        }
                    }
                    return [3 /*break*/, 5];
                case 4:
