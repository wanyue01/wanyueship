...
var Form = forwardRef(function (props, ref) {
    ...
    var validateField = rest.validateField, validateAllFields = rest.validateAllFields;
    useImperativeHandle(ref, function () { return (__assign({}, rest)); });
    var passedContext = {
        dispatch: dispatch,
        fields: fields,
    ...
    console.log(fields);
    return (React.createElement("form", { name: name, className: 'form-component', onSubmit: handleSubmit },
